...
/**
 * Responsible for updating the shared render info list when a packet is
 * received.
 */
public class SCPacketHudUpdateHandler implements IMessageHandler<SCPacketHudUpdate, SCPacketHudUpdate> {
	...
	public SCPacketHudUpdate onMessage(SCPacketHudUpdate message, MessageContext ctx) {
		...
		List<InvasionHudRenderInfo> sortedCopy = InvasionHudRenderInfoComparator.ORDERING_INSTANCE
				.sortedCopy(invasionHudRenderInfoList);
