...
public class SpawnerMobForced {
	...
	public SpawnerMobForced(SpawnSampler spawnSampler, Function<String, MobTemplate> mobTemplateFunction,
			MobTemplateEntityFactory mobTemplateEntityFactory, List<DeferredSpawnData> deferredSpawnDataList,
	...
	public boolean attemptSpawnMob(World world, BlockPos playerPos, UUID invasionUuid, UUID playerUuid, int waveIndex,
		...
		DeferredSpawnData deferredSpawnData = new DeferredSpawnData(entity, world.provider.getDimension(),
				entity.getPosition(), invasionUuid, playerUuid, waveIndex, mobIndex, spawnDataCopy.type, secondaryMob,
