...
public class CommandStartInvasion extends CommandBase {
	...
	public CommandStartInvasion(InvasionCommandStarter invasionCommandStarter,
	...
	private void startInvasionsForNRandomPlayers(ICommandSender sender, String templateId, int count,
			List<EntityPlayerMP> players) throws CommandException {
	...
	private void startInvasionForPlayer(ICommandSender sender, String templateId, EntityPlayerMP player)
