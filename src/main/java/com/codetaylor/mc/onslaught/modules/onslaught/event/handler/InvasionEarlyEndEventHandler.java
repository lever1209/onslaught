...
public class InvasionEarlyEndEventHandler {
	...
	public InvasionEarlyEndEventHandler(InvasionCommandExecutor commandExecutorStart,
			InvasionCommandExecutor commandExecutorEnd, InvasionCommandExecutorStaged commandExecutorStaged) {
