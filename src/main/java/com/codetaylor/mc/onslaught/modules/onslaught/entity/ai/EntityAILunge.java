...
/**
 * Responsible for temporarily increasing an entity's movement speed while
 * within range of their attack target.
 */
	...
	public void startExecuting() {
		...
		if (attackTarget == null || this.taskOwner.getDistanceSq(attackTarget) > this.rangeSq) {
			...
			if (this.attributeInstance.getModifier(LUNGE_SPEED_BOOST_ID) == null) {
				AttributeModifier attributeModifier = new AttributeModifier(LUNGE_SPEED_BOOST_ID, "Lunge speed boost",
