...
public class InvasionKillCountUpdateEventHandler {
	...
	public void on(ExplosionEvent.Start event) {
		...
		// we know we're in a remote world. Pretty sure there's a cleaner way, but bug
		// fix first.
		// noinspection ConstantConditions
		this.invasionKillCountUpdater.onDeath(InvasionGlobalSavedData.get(world), entity.getEntityData(),
