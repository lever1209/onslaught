...
public class EntityAILungeInjector extends EntityAIInjectorBase {
	...
	public void inject(EntityLiving entity, NBTTagCompound tag) {
		...
		double speedModifier = this.getDouble(aiTag, Tag.AI_PARAM_SPEED_MODIFIER,
				ModuleOnslaughtConfig.CUSTOM_AI.LUNGE.DEFAULT_SPEED_MODIFIER);
