...
/**
 * This class is registered with the Gson instance used to deserialize Onslaught
 * json files. It is responsible for converting the json into an
 * {@link NBTTagCompound}. This adapter does not support serialization and will
 * throw an {@link UnsupportedOperationException} on write.
 */
public class NBTTagCompoundTypeAdapter extends TypeAdapter<NBTTagCompound> {
	...
	private static final Pattern DOUBLE_PATTERN = Pattern.compile("[-+]?(?:[0-9]+[.]|[0-9]*[.][0-9]+)(?:e[-+]?[0-9]+)?",
