 ...
 * <a href=https://tvtropes.org/pmwiki/pmwiki.php/Main/OffscreenTeleportation>Offscreen
 * Teleport</a> like a horror movie monster.
 */
public class EntityAIOffscreenTeleport extends EntityAIBase {
	...
	public EntityAIOffscreenTeleport(EntityLiving taskOwner, int rangeThreshold, float teleportFactor,
			boolean ableToHopDim) {
	 ...
	 *
	 * <p>
	 * Used to determine teleport distances for moving a mob towards it's target. A
	 * factor of .5 moves it halfway. Values greater than 1.0 will result in going
	 * past the target.
	 *
	 ...
	 *
	 * <p>
	 * We will attempt once to teleport the mob towards the target. The mob gets 1
	 * tick of invisibility (to make most mobs less jarring when they relocate and
	 * plays its sound at destination. Armor and tools are still visible during
	 * teleport.
	 *
	 * <p>
	 * This is counted as an Ender Teleport event on success.
	 */
	...
	/**
	 * A few ticks of invisibility to make the mob unseen as it is teleported to the
	 * other side of the player, when the factor > 1.
	 *
