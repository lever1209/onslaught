...
public class EntityAIAntiAirInjector extends EntityAIInjectorBase {
	...
	public void inject(EntityLiving entity, NBTTagCompound tag) {
		...
		int range = this.getInteger(aiTag, Tag.AI_PARAM_RANGE, ModuleOnslaughtConfig.CUSTOM_AI.ANTI_AIR.DEFAULT_RANGE);
		boolean sightRequired = this.getBoolean(aiTag, Tag.AI_PARAM_SIGHT_REQUIRED,
				ModuleOnslaughtConfig.CUSTOM_AI.ANTI_AIR.DEFAULT_SIGHT_REQUIRED);
		double motionY = this.getDouble(aiTag, Tag.AI_PARAM_MOTION_Y,
