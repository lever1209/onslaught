...
public class InvasionCommandExecutorStaged {
	...
	public InvasionCommandExecutorStaged(Function<String, InvasionTemplate> idToInvasionTemplateFunction,
	...
	public void execute(EntityPlayerMP player, InvasionPlayerData.InvasionData invasionData) {
		...
		if (ModuleOnslaughtConfig.DEBUG.INVASION_COMMANDS) {
			String message = String.format("Invasion with id %s is %f percent complete, querying %d staged commands",
