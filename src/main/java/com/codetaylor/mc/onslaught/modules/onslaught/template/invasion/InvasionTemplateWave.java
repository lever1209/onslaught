...
public class InvasionTemplateWave {
	...
	/**
	 * The delay from the start of the invasion before this wave is spawned. Can be
	 * specified as a single, fixed value or two min/max values.
	 */
	...
	public enum EnumSpawnType {
		...
		/*
		 * These are lowercase for consistency between the json templates, the default
		 * config values, and the serialized player data NBT.
		 */
	...
	public static class Mob {
		...
		/**
		 * The number of mobs to spawn from this template. Can be specified as a single,
		 * fixed value or two min/max values.
		 */
		public int[] count = { 1 };
