...
public class DeferredSpawnClientParticlePacketSender implements InvasionUpdateEventHandler.IInvasionUpdateComponent {
	...
	public void update(int updateIntervalTicks, InvasionGlobalSavedData invasionGlobalSavedData, PlayerList playerList,
		...
		for (DeferredSpawnData deferredSpawnData : this.deferredSpawnDataList) {
			...
			SCPacketDeferredSpawn packet = new SCPacketDeferredSpawn(entityLiving.posX, entityLiving.posY,
					entityLiving.posZ);
