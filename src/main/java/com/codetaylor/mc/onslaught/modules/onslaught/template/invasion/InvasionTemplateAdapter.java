...
public class InvasionTemplateAdapter {
	...
	public InvasionTemplateAdapter() {
		...
		this.gson = new GsonBuilder().registerTypeAdapter(Stages.class, StagesTypeAdapter.INSTANCE).create();
	}

	public Map<String, InvasionTemplate> adapt(String json) {

		Type type = new TypeToken<Map<String, InvasionTemplate>>() {
			//
		}.getType();
