...
public class InvasionCommandStarter {
	...
	public boolean startInvasionForPlayer(String templateId, EntityPlayerMP player) {
		...
		InvasionPlayerData.InvasionData invasionData = this.invasionPlayerDataFactory.create(templateId,
				UUID.randomUUID(), player.getRNG(), 0, -1, -1);
		...
		MinecraftForge.EVENT_BUS.post(
				new InvasionStateChangedEvent(player, invasionState, InvasionPlayerData.EnumInvasionState.Active));
