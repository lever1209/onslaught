...
/**
 * Responsible for transitioning a player's invasion state from active to
 * waiting.
 */
public class StateChangeActiveToWaiting implements InvasionUpdateEventHandler.IInvasionUpdateComponent {
