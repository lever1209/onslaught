...
/**
 * Responsible for containing all the data necessary to perform a deferred
 * spawn.
 */
public class DeferredSpawnData {
	...
	public DeferredSpawnData(EntityLiving entityLiving, int dimensionId, BlockPos pos, UUID invasionUuid,
			UUID playerUuid, int waveIndex, int mobIndex, InvasionTemplateWave.EnumSpawnType spawnType,
			InvasionTemplateWave.SecondaryMob secondaryMob, int ticksRemaining) {
	...
	public String toString() {
		...
		return "DeferredSpawnData{" + "entityLiving=" + this.entityLiving + ", dimensionId=" + this.dimensionId
				+ ", pos=" + this.pos + ", invasionUuid=" + this.invasionUuid + ", playerUuid=" + this.playerUuid
				+ ", waveIndex=" + this.waveIndex + ", mobIndex=" + this.mobIndex + ", spawnType=" + this.spawnType
				+ ", secondaryMob=" + this.secondaryMob + ", ticksRemaining=" + this.ticksRemaining + '}';
	}
}
